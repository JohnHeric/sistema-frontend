...
import { gravarProduto, alterarProduto, consultarProduto, excluirProduto } from "../servicos/servicoProduto";

import ESTADO from "./estados";

export const adicionarProduto = createAsyncThunk('apagarProduto', async (produto)=>{

})

export const editarProduto = createAsyncThunk('apagarProduto', async (produto)=>{
